...
void off()
{
	...
	if(plate_led > 0)
	{
		for(int n = 0; n < 8; n++)
		{
			pixel.setPixelColor(pairs[n][0], black.r, black.g, black.b);
			pixel.setPixelColor(pairs[n][1], black.r, black.g, black.b);
		}
	}
	paintPixel(0);
}
...
{
	off();
	pixel.setPixelColor(PUNCHS[0].index, blue.r, blue.g, blue.b);
	pixel.setPixelColor(PUNCHS[0].index+1, blue.r, blue.g, blue.b);
	pixel.setPixelColor(PUNCHS[1].index, yellow.r, yellow.g, yellow.b);
	pixel.setPixelColor(PUNCHS[1].index+1, yellow.r, yellow.g, yellow.b);
	pixel.setPixelColor(KICKS[0].index, green.r, green.g, green.b);
	pixel.setPixelColor(KICKS[0].index+1, green.r, green.g, green.b);
	pixel.setPixelColor(KICKS[1].index, red.r, red.g, red.b);
	pixel.setPixelColor(KICKS[1].index+1, red.r, red.g, red.b);
	pixel.show();
}
...
{
	off();
	pixel.setPixelColor(PUNCHS[0].index, violet.r, violet.g, violet.b);
	pixel.setPixelColor(PUNCHS[0].index+1, violet.r, violet.g, violet.b);
	pixel.setPixelColor(PUNCHS[1].index, green.r, green.g, green.b);
	pixel.setPixelColor(PUNCHS[1].index+1, green.r, green.g, green.b);
	pixel.setPixelColor(KICKS[0].index, blue.r, blue.g, blue.b);
	pixel.setPixelColor(KICKS[0].index+1, blue.r, blue.g, blue.b);
	pixel.setPixelColor(KICKS[1].index, red.r, red.g, red.b);
	pixel.setPixelColor(KICKS[1].index+1, red.r, red.g, red.b);
	pixel.show();
}
